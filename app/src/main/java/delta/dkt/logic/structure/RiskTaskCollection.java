...
public class RiskTaskCollection {
    ...
    public RiskTaskCollection(){
        riskTask.add(new OutOfJailCard(1,"JailCard","Gehe in den Arrest!"));
        riskTask.add(new OutOfJailCard(2,"OutOfJailCard","Diese Karte befreit dich aus dem Arrest! Hebe diese Karte auf, du wirst sie brauchen."));
