...
public class PropertyListActivity extends AppCompatActivity {
    ...
    protected void sendDataToFragment() {
        BlockFragment blockNumber1 = BlockFragment.newInstance("Fragment1", "1", "Testprop", 5, "Player1", 1);
        BlockFragment blockNumber2 = BlockFragment.newInstance("Fragment2", "2", "Testprop2", 10, "Player2", 2);
        BlockFragment blockNumber3 = BlockFragment.newInstance("Fragment3", "3", "Testprop3", 100, "Player3", 3);
        BlockFragment blockNumber4 = BlockFragment.newInstance("Fragment4", "4", "Testprop4", 5, "Player4", 4);
